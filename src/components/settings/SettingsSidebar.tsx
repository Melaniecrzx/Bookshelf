import { AlertTriangle, Paintbrush2, BookOpen } from "lucide-react";
import type { LucideIcon } from "lucide-react";

export type SectionId = "appearance" | "reading" | "danger";
...
export function SettingsSidebar({ active, onChange }: SettingsSidebarProps) {
  return (
    <aside className="hidden md:flex flex-col w-52 shrink-0">
      ...
      <div className="mt-auto pt-6 border-t border-sand-200 mt-6">
        <button
